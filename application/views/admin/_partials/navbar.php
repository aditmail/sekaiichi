<nav class="navbar navbar-expand navbar-dark bg-white static-top">
  ...
  <a class="navbar-brand mr-1" style="color:black;font-weight:bold" href="<?php echo site_url('admin') ?>">
    <img src="<?php echo base_url('assets/images/logo_detail_sekaiichi.png')?>" style="margin:5px;" width="180" height="60"/>
  </a>
  ...
  <!-- Navbar -->
  <ul class="navbar-nav ml-auto ml-md-0" style="position: absolute; margin:10px; top:20px; right:10px;">
